...
def optcal_pulse(params,amp = 1,return_opt = 0):
    #return_opt specifies whether you want the function to return the waveform or the parameterized signal
    ...
    n = int(num_params/2)       ##number of samples, affects the Total duration of the pulse
    T = dt * n
...
def optcal_pulse_new(params,amp = 1,return_opt = 0):
    #return_opt specifies whether you want the function to return the waveform or the parameterized signal
    ...
    n = 48       ##number of samples, affects the Total duration of the pulse
    T = dt * n
    nzeros = 24
